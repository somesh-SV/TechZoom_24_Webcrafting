    ...
    <section class="text-gray-50 ">
      <div class="container px-5 py-24 mx-auto">
        <div class="flex flex-col text-center w-full mb-12">
          <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-50">
            Contact Us
          </h1>
          <p class="lg:w-2/3 mx-auto text-xl">Feel free to contact us.</p>
        </div>
        <div class="lg:w-1/2 md:w-2/3 mx-auto backdrop-blur-sm bg-white/30 px-8 p-4 rounded-lg">
